"""
Django settings for tripmaster project.
...
SECRET_KEY = 'django-insecure-+#i0s$2m$(-+%ij0d)9$vv09(60=*&d8u3)w)je_@_5!pqd=^q'
...
WSGI_APPLICATION = 'tripmaster.wsgi.application'
